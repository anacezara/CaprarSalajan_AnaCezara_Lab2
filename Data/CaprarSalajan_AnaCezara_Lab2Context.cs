...
namespace CaprarSalajan_AnaCezara_Lab2.Data
{
    public class CaprarSalajan_AnaCezara_Lab2Context : DbContext
    {
        ...
        public DbSet<CaprarSalajan_AnaCezara_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<CaprarSalajan_AnaCezara_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<CaprarSalajan_AnaCezara_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
